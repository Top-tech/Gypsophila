...
describe('MixinColor', () => {
  ...
  it('should remove old color classes if new color is set', () => {
    ...
    expect(instance.testElement.classList)
      .toContain('gyp-primary', 'Expected the element to have the "gyp-primary" class set');

    instance.color = 'accent';

    expect(instance.testElement.classList)
      .not.toContain('gyp-primary', 'Expected the element to no longer have "gyp-primary" set.');
    expect(instance.testElement.classList)
      .toContain('gyp-accent', 'Expected the element to have the "gyp-accent" class set');
  });
  ...
  it('should allow having a default color if specified', () => {
    ...
    expect(instance.testElement.classList)
      .toContain('gyp-accent', 'Expected the element to have the "gyp-accent" class by default.');

    instance.color = undefined;

    expect(instance.testElement.classList)
      .toContain('gyp-accent', 'Expected the default color "gyp-accent" to be set.');
  });
